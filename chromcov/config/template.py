...
_SECTION_HEADINGS = {
    "inputs": "inputs -- cram + reference are required (no default)",
...
def render_default_config() -> str:
    ...
    header = (
        ...
        "# matches the code. Copy freely, fill in inputs.cram / inputs.reference, and edit\n"
        f"# what you need. CLI flags override anything here.\n"
